/*
===============================================================================
 *  ESP32-S3 16-Channel Relay Smart Switch with Full MQTT Support
 *  Author: Raff Alds
...
void publishHADiscovery() {
    ...
    for (int i = 0; i < getActiveRelayCount(); i++) {
        ...
        device["model"] = "ESP32-S3 16CH Relay";
...
<div class="fg"><label style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13px;font-weight:600;color:#1A1A2E;text-transform:none">
<input type="checkbox" id="haDiscovery" checked style="width:18px;height:18px;cursor:pointer;accent-color:#1565C0"><span>Enable Home Assistant Auto-Discovery</span></label>
<small>Automatically creates entities in Home Assistant via MQTT Discovery protocol. When enabled, the device will appear in Home Assistant automatically.</small></div>
