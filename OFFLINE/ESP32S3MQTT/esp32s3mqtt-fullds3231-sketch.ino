/*
===============================================================================
 *  ESP32S3 16-Channel Automatic Relay Smart Switch with Full MQTT Support no NTP
 *  Author: Raff Alds
...
<small>When disabled, ESP32S3 runs in AP-only mode. Relay schedules using internal RTC/DS3231 will still work.</small>
</div>
<hr>
