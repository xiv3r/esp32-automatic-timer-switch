/*
============================================================
 *  ESP32 16-Channel Relay Smart Switch — Firmware v4
...
<div class="card-hdr"><span class="ctitle">Relay ${i+1}</span><span class="badge ${sc}">${sl}</span></div>
<div class="brow">
...
// =============================================================================
//  CONFIGURATION  (load / save using Preferences)
// =============================================================================
...
void initDefaults() {
    ...
    for (int i = 0; i < NUM_RELAYS; i++) memset(&relayConfigs[i], 0, sizeof(RelayConfig));
    saveConfiguration();
}
