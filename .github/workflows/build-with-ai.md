...
1.Download the sketch.ino file
...
6.Then upload the 4 generated firmware for boot, partition, firmware and merged .bin to the workspace so user can download it directly.
