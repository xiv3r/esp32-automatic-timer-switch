...
8. Time Management
9. WiFi & Networking
10. Relay Control & Scheduling
11. Self-Healing System
12. GPIO Configuration
13. DS3231 RTC Support
14. NTP Synchronization
15. Access Point Mode
16. mDNS Support
...
│   └── mDNS Server
├── Storage Systems
│   ├── Preferences/NVS (System Config)
│   ├── Preferences/NVS (Ext Config)
│   ├── Preferences/NVS (GPIO Config)
│   ├── Preferences/NVS (Relay Configs)
...
· Memory Cleanup: Every 30 seconds (stale), every 1 hour (full)
...
· DS3231 RTC: ~200μA (battery-backed)
