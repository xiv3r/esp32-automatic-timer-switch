/*
============================================================
 *  ESP32-C3 16-Channel Relay Smart Switch
 *  Author: github.com/xiver
============================================================
 */
...
// AP copies
char ap_ssid[32]     = "ESP32_C3_16CH_Timer_Switch";
...
<header>
<span class="logo">&#x26A1; ESP32-C3 16-CH</span>
<nav>
...
void setup() {
    ...
    // WRITE_PERI_REG(RTC_CNTL_BROWN_OUT_REG, 0); // Brownout protection
    ...
    // ESP32-C3 info
    Serial.begin(115200);
    Serial.println("ESP32-C3 16-Channel Relay Smart Switch v5");
    Serial.println("GPIO pins: 0-11, 18-21");
    Serial.print("AP IP: ");
...
void initDefaults() {
    ...
    strcpy(sysConfig.ap_ssid,     "ESP32C3_16CH_Timer");
