/*
===============================================================================
 *  ESP32 16-Channel Relay Smart Switch with Full MQTT Support
 *  Author: Raff Alds
...
<div class="fg"><label style="display:flex;align-items:center;gap:8px;cursor:pointer"><input type="checkbox" id="haDiscovery" checked><span>Enable Home Assistant Auto-Discovery</span></label></div>
