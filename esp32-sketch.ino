...
function updateTimeStatus(d){
  ...
  if(d.timeSource==='ntp'){
    ...
    icon='&#x1F4BF;';msg='Time source: <strong>DS3231 Hardware RTC</strong> — Primary authority, temperature-compensated';
    cls='ai';
  }else{
  ...
  let rtcInfo = '';
  if(d.rtcPresent){
    rtcInfo = '<br><small>✅ DS3231 RTC detected on GPIO21/22 — Internal RTC corrected from DS3231';
