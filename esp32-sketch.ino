...
<div class="card fcrd">
<div class="alert aw">&#x26A0;&#xFE0F; Changing SSID or Password will restart the AP and disconnect all clients. Reconnect to the new SSID afterward.</div>
...
void handleSaveAP() {
    ...
    if (ssid && strlen(ssid) > 0 && strlen(ssid) < 32) {
        bool ssidChanged = (strcmp(sysConfig.ap_ssid, ssid) != 0);
        bool passChanged = false;        
