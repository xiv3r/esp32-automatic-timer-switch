...
// ESP32-safe GPIO pins (avoid strapping pins, flash pins, etc.)
const int  relayPins[NUM_RELAYS] = { 
    16, 17, 18, 19, 21, 22, 23, 25, 
    26, 27, 32, 33, 13, 14, 4, 5 
};
...
void startMDNS() {
    ...
    while (retries-- > 0) {
        if (MDNS.begin(mdnsHostname)) {
            ...
            MDNS.addServiceTxt("http", "tcp", "model", "ESP32-16CH-Relay");
...
void setup() {
    Serial.begin(115200);
    Serial.println("\n[Boot] ESP32 16-Ch Relay v4.1 (Fixed)");
